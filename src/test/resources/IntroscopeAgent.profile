...
introscope.autoprobe.directivesFile=tomcat-typical.pbl,hotdeploy
...
introscope.agent.enterprisemanager.transport.tcp.host.DEFAULT=lx-hsiscpe-t83k  
introscope.agent.enterprisemanager.transport.tcp.port.DEFAULT=5701  
